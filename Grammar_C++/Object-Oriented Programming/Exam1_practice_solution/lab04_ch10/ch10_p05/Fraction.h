...
public:
	void add      ( const CFraction& fr );//this + fr
	void subtract ( const CFraction& fr );//this - fr
	void multiply ( const CFraction& fr );//this * fr
	void divide   ( const CFraction& fr );//this / fr
